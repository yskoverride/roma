<div class="mt-2 bg-gray-100 rounded-lg">
    ...
    <div class="flex justify-between items-center px-3 border-b border-gray-200 pb-2">
        ...
        <button type="button" class="text-center group cusor-pointer focus:outline-none" 
            ...
            <div class="hover:bg-white text-lg leading-none p-1 rounded-full w-9 h-9 group-hover:bg-gray-200 flex items-center justify-center {{ $date === $day->timestamp ? 'bg-gray-600' : '' }}">
                {{ $day->format('d') }}
            </div>
        </button>
        @endforeach
