    ...
    <div x-data="{ desktop: true, profile: false, mobile:false }">
        ...
        <div  style="display: none !important" x-show.important="mobile" class="relative z-50 lg:hidden" role="dialog" aria-modal="true"
            ...
            <div style="display: none !important" x-show.important="mobile" class="relative mr-16 flex w-full max-w-xs flex-1"
                ...
                <button type="button" x-on:click="mobile=false" class="-m-2.5 p-2.5">
                ...
                <nav class="flex flex-1 flex-col">
                    ...
                    <li>
                        ...
                        <li>
                            ...
                            <a href="/dashboard" class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        ...
                        <li>
                            <a href="/doctors" class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                        ...
                        <li>
                            <a href="/patients" class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                        ...
                        <li>
                            <a href="/appointment/create" class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                    ...
                    <li class="mt-auto">
                        <a href="/settings" class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-400 hover:bg-gray-800 hover:text-white">
                        <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
            ...
            <div class="flex h-16 shrink-0 items-center">
                <p class="text-gray-100 font-bold text-2xl text-center">Roma.</p>
            </div>
            <nav class="flex flex-1 flex-col">
                <ul role="list" class="flex flex-1 flex-col gap-y-7">
                <li>
        ...
        <div class="lg:pl-72">
            ...
            <button x-on:click="mobile=true" type="button" class="-m-2.5 p-2.5 text-gray-700 lg:hidden">
            ...
            <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                ...
                <div class="relative">
                    ...
                    <img class="h-8 w-8 rounded-full bg-gray-50" src="https://www.gravatar.com/avatar/{{ md5(Auth::user()->email) }}" alt="">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <a href="/logout" class="block px-3 py-1 text-sm leading-6 text-gray-900" role="menuitem" tabindex="-1" id="user-menu-item-1"
